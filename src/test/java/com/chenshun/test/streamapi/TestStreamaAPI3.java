package com.chenshun.test.streamapi;

import com.chenshun.test.streamapi.Employee.Status;
...
public class TestStreamaAPI3 {
    ...
    @Test
    public void test2() {
        Optional<Employee> op1 = emps.stream().sorted((e1, e2) -> Double.compare(e1.getSalary(), e2.getSalary()))
                .findFirst();
