package com.chenshun.utils.prop;
...
/**
 * User: mew <p />
 * Time: 17/7/11 15:34  <p />
 * Version: V1.0  <p />
 * Description: PropKit. PropKit can load properties file from CLASSPATH or File object. <p />
 */
public class PropKit {
    ...
    public static Prop getProp() {
        if (prop == null) {
            throw new
                    IllegalStateException("Load propties file by invoking PropKit.use(String fileName) method first.");
        }
        return prop;
    }
